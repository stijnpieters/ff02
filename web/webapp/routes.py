...
def get_data():
    if request.method == "GET":
        ...
        result = client_influx.query("select * from $measurement where time >= now()-30m and serienummer_meter=$serial", bind_params={'measurement': measurement, 'serial': serial_number})
